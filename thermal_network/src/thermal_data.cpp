...
private:
  ...
  // Custom colorpalette
  std::vector<int> colormap_ironblack_ = {255, 255, 255, 253, 253, 253, 251, 251, 251, 249, 249, 249,
  ...
  void process_data()
  {
    ...
    for (int iSegment = 1; iSegment <=4; iSegment++)
    {
      ...
      for (int i = 0; i < 4920; i++)
      {
        ...
        int ofs_r = 3 * value + 0; if (selectedColormapSize_ <= ofs_r) ofs_r = selectedColormapSize_ - 1;
        int ofs_g = 3 * value + 1; if (selectedColormapSize_ <= ofs_g) ofs_g = selectedColormapSize_ - 1;
        int ofs_b = 3 * value + 2; if (selectedColormapSize_ <= ofs_b) ofs_b = selectedColormapSize_ - 1;
